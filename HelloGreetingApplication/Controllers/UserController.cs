...
public class UserController : ControllerBase
{
    ...
    public UserController(AppDbContext context, JwtHelper jwtHelper, EmailService emailService, IConfiguration configuration)
    {
        _context = context;
    ...
    public async Task<IActionResult> Register([FromBody] UserModel user)
    {
        ...
        var newUser = new UserEntity { Email = user.Email, PasswordHash = hashedPassword, Salt = salt };
